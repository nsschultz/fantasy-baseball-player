...
namespace FantasyBaseball.PlayerService.Services.UnitTests
{
  public class AddPlayerServiceTest
  {
    ...
    public async void AddPlayerTestExistingIdException()
    {
      ...
      var player = new BaseballPlayer { BhqId = 100, Type = PlayerType.B };
      var playerRepo = new Mock<IPlayerRepository>();
      playerRepo.Setup(o => o.GetPlayerByBhqId(It.Is<int>(i => i == 100), It.Is<PlayerType>(t => t == PlayerType.B))).ReturnsAsync(new PlayerEntity { });
    ...
    public async void AddPlayerTestValid()
    {
      var mapper = new MapperConfiguration(cfg => cfg.AddProfile(new PlayerEntityProfile())).CreateMapper();
      var id = Guid.NewGuid();
      var player = new BaseballPlayer { Id = id, BhqId = 100, Type = PlayerType.B };
      var playerRepo = new Mock<IPlayerRepository>();
      playerRepo.Setup(o => o.GetPlayerByBhqId(It.Is<int>(i => i == 100), It.Is<PlayerType>(t => t == PlayerType.B))).ReturnsAsync((PlayerEntity)null);
