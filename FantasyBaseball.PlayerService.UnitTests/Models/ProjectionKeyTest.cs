...
namespace FantasyBaseball.PlayerService.Models.UnitTests
{
    public class ProjectionKeyTest
    {
        ...
        public void GetHashCodeEqualsTest() =>
            Assert.Equal(BaseTestObj.GetHashCode(), new ProjectionKey(10, PlayerType.B).GetHashCode());

        [Fact]
        public void GetHashCodeNotEqualsTest() =>
            Assert.NotEqual(BaseTestObj.GetHashCode(), new ProjectionKey(1, PlayerType.P).GetHashCode());
    }
}