...
{
  public class PitchinStatsRepositoryTest : IDisposable
  {
    private readonly PlayerContext _context;

    public PitchinStatsRepositoryTest() => _context = CreateContext().Result;

    public Guid PlayerMatchingId { get; private set; }

    [Fact]
    public async void DeleteAllPitchingStatsTest()
    {
