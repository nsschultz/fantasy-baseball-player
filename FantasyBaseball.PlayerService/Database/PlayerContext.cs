...
namespace FantasyBaseball.PlayerService.Database
{
  ...
  public class PlayerContext(DbContextOptions<PlayerContext> options) : DbContext(options), IPlayerContext
  {
    ...
    private static void BuildTeamModel(EntityTypeBuilder<TeamEntity> builder)
    {
      ...
      builder.HasData(
        ...
        new TeamEntity { Code = "WAS", LeagueId = "NL", City = "Washington", Nickname = "Nationals", AlternativeCode = "WSH" },
        new TeamEntity { Code = "CHC", LeagueId = "NL", City = "Chicago", Nickname = "Cubs", AlternativeCode = "CHI" },
